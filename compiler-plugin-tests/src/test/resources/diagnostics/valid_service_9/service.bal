...
service cdc:Service on cdcListener {
    ...
    remote function onRead(Person after) returns cdc:Error? {
    }
...
service cdc:Service on cdcListener {
    ...
    remote function onRead(map<Person> after) returns cdc:Error? {
    }
...
service cdc:Service on cdcListener {
    ...
    remote function onRead(readonly & map<Person> after) returns cdc:Error? {
    }
